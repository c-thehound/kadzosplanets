"""
Django settings for kadzo_elite project.
...
SECRET_KEY = 'uo&-r@kv*6u^xp!07%rbq5q!ar4w*+jc+007vwyy(jy7f70tcy'
...
WSGI_APPLICATION = 'kadzo_elite.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'kadzosplanets@gmail.com'
...
MARTOR_UPLOAD_PATH = '{}/media/martor-images/{}'.format(AWS_S3_CUSTOM_DOMAIN,time.strftime("%Y/%m/%d"))
